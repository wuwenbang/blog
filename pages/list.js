            ...
            renderItem={item => (
              <List.Item>
                ...
                <div className="list-icons">
                  <span className="list-icon"><CalendarOutlined />2021-3-7</span>
                  <span className="list-icon"><FolderOutlined />视频教程</span>
                  <span className="list-icon"><FireOutlined />9999人</span>
                </div>
